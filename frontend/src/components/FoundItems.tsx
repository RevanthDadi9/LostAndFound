...
import { Card, Button, Input, Space, Carousel, Spin } from 'antd';
const { Meta } = Card;
...
const FoundItems: React.FC = () => {
  ...
  let title: string = `Hi ${getUserName()}!👋, Here you can find the Found items!`
  ...
  return (
    <>
      {filteredItems.length === 0 && items.length === 0 ? (
        ...
        <>
          <Title level={3} style={{ background: 'linear-gradient(75deg,rgb(8, 103, 176),rgb(44, 158, 88))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', display: 'inline-block', marginTop: 16, marginLeft: 370 }}>
            {title}
          </Title>
